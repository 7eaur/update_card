...
<section class="page-hero section-shell">
  <div class="container page-hero__grid">
    <div>
      ...
      <h1>منذ ${site.since}، نعمل في عالم الخدمات الرقمية</h1>
      <p>خبرة متخصصة في الشحن والدفع والشراء الإلكتروني وخدمات رقمية متعددة للأفراد وقطاع الجملة.</p>
    </div>
    <div class="page-hero__visual">${renderResponsiveImage({ name: 'about', alt: 'هوية أبديت كارد في مشهد رقمي عالمي', className: 'page-hero__image', variant: 'page', loading: 'eager' })}</div>
  </div>
</section>
...
<section class="content-section section-shell">
  <div class="container value-cards">
    <article><span>01</span><h2>سرعة</h2><p>تنفيذ منظم واستجابة مباشرة ضمن طبيعة الخدمة وتوفرها.</p></article>
    <article><span>02</span><h2>وضوح</h2><p>تأكيد التفاصيل والتوفر والسعر قبل التنفيذ.</p></article>
    <article><span>03</span><h2>موثوقية</h2><p>تعامل واضح ومتابعة مباشرة من الاستفسار حتى اكتمال الخدمة.</p></article>
  </div>
</section>
